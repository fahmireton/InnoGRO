...
class KnowledgeHubScreen extends StatelessWidget {
  ...
  static const _diseases = [
    _DiseaseData('Rice Blast', 'Magnaporthe oryzae',
        'Diamond-shaped lesions on leaves; can destroy whole panicles.',
        Icons.bug_report_outlined),
    _DiseaseData('Sheath Blight', 'Rhizoctonia solani',
        'Greyish lesions on leaf sheaths near waterline.',
        Icons.eco_outlined),
    _DiseaseData('Bacterial Leaf Blight', 'Xanthomonas oryzae',
        'Yellow streaks turning to grey-white wilting on leaves.',
        Icons.water_drop_outlined),
    _DiseaseData('Brown Spot', 'Bipolaris oryzae',
        'Small brown oval spots; common in nutrient-poor soils.',
  ...
  static const _stages = [
    ...
    _StageData('Flowering', '65–85',
        'Most vulnerable to blast; preventive spray helps.'),
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  _sectionLabel(context, 'COMMON PADDY DISEASES'),
                  ...
                  _sectionLabel(context, 'PREVENTION TIPS'),
                  const SizedBox(height: 10),
                  _card(context,
                      child: Column(
                  ...
                  const SizedBox(height: 24),
                  _sectionLabel(context, 'GROWTH STAGES'),
                  const SizedBox(height: 10),
                  _card(context,
                      child: Column(
                        children: _stages.asMap().entries.map((e) {
                          ...
                          return Padding(
                            padding: EdgeInsets.only(
                                bottom: i < _stages.length - 1 ? 16 : 0),
                            child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                              Container(
