...
class _ResultScreenState extends State<ResultScreen> {
  ...
  void _openSupplier(String product) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Opening supplier for "$product"…'),
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              ...
              if (d.symptoms.isNotEmpty || d.causes.isNotEmpty) ...[
                _sectionLabel(context, 'DISEASE INFO'),
                const SizedBox(height: 12),
                _accordionCard(context),
                const SizedBox(height: 24),
              ],
              if (d.organicTreatments.isNotEmpty ||
                  d.chemicalTreatments.isNotEmpty) ...[
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('CONFIDENCE',
                  style: TextStyle(
                      ...
                      color: context.textSecondary,
                      letterSpacing: 1)),
              Text('${d.confidence.toStringAsFixed(0)}%',
                  style: TextStyle(
                      fontSize: 36,
                      fontWeight: FontWeight.w900,
                      color: context.textPrimary,
                      letterSpacing: -1)),
              Text('Recovery ≈ ${d.recoveryTime}',
                  style: TextStyle(
    ...
    final sections = [
      ...
      (
        ...
        [
          ...
          'Germination occurs within 6–8 hours at high humidity',
          'New lesions appear within 7–10 days of infection'
        ]
      ),
  ...
  Widget _treatmentCard(BuildContext context) {
    final treatments =
        _organicSelected ? d.organicTreatments : d.chemicalTreatments;
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(children: [
              _tabBtn(context, '🌱  Organic', _organicSelected,
                  () => setState(() => _organicSelected = true)),
              _tabBtn(context, '⚗️  Chemical', !_organicSelected,
                  () => setState(() => _organicSelected = false)),
            ]),
          ),
          const SizedBox(height: 18),
          ...List.generate(
              treatments.isNotEmpty
                  ? math.min(treatments.length * 2, 5)
                  : 5, (i) {
            final steps = treatments.isNotEmpty
                ? treatments
                    .expand((t) => t.instructions.split('. '))
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Row(children: [
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    onChanged: (v) =>
                        setState(() => _acres = double.tryParse(v) ?? _acres),
                ...
                const Spacer(),
                Text(
                    'RM ${(_acres * costPerAcre).toStringAsFixed(0)}',
                    style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.w900,
                        color: context.textPrimary,
              ...
              Align(
                  ...
                  child: Text(
                      '≈ RM ${costPerAcre.toStringAsFixed(0)} per acre',
                      style: TextStyle(
                          fontSize: 11,
                          color: context.textSecondary))),
            ]),
          ...
          Row(children: [
            ...
            Expanded(
              child: ElevatedButton.icon(
                ...
                label: const Text('Apply treatment',
                    style: TextStyle(
  ...
  Widget _tabBtn(BuildContext context, String label, bool selected,
          VoidCallback onTap) =>
      Expanded(
        child: GestureDetector(
          onTap: onTap,
